...
public class TelaInformacoesEmpresa extends javax.swing.JInternalFrame {
    ...
    private void cadastrarParcelas() throws ClassNotFoundException, SQLException{
        ...
        parcela1.setPercento(Double.parseDouble(txtJurosAVista.getText()));
        parcela2.setIdParcela(2);
        parcela2.setPercento(Double.parseDouble(txtJurosDuasParcelas.getText()));
        parcela3.setIdParcela(3);
        parcela3.setPercento(Double.parseDouble(txtJurosTresParcelas.getText()));
        parcela4.setIdParcela(4);
        parcela4.setPercento(Double.parseDouble(txtJurosQuatroParcelas.getText()));
        parcela5.setIdParcela(5);
        parcela5.setPercento(Double.parseDouble(txtJurosCincoParcelas.getText()));
        parcela6.setIdParcela(6);
        parcela6.setPercento(Double.parseDouble(txtJurosSeisParcelas.getText()));
        parcela7.setIdParcela(7);
        parcela7.setPercento(Double.parseDouble(txtJurosSeteParcelas.getText()));
        parcela8.setIdParcela(8);
        parcela8.setPercento(Double.parseDouble(txtJurosOitoParcelas.getText()));
        parcela9.setIdParcela(9);
        parcela9.setPercento(Double.parseDouble(txtJurosNoveParcelas.getText()));
        parcela10.setIdParcela(10);
        parcela10.setPercento(Double.parseDouble(txtJurosDezParcelas.getText()));
        parcela11.setIdParcela(11);
        parcela11.setPercento(Double.parseDouble(txtJurosOnzeParcelas.getText()));
        parcela12.setIdParcela(12);
        parcela12.setPercento(Double.parseDouble(txtJurosDozeParcelas.getText()));
